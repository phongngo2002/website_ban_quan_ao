...
<link rel="stylesheet" href="{{asset('templates/admin/vendors/iconly/bold.css')}}">
<style>
    .close:hover{
        color: red;
        cursor: pointer;
...
<link rel="stylesheet" href="{{asset('templates/admin/vendors/perfect-scrollbar/perfect-scrollbar.css')}}">
